...
export function TaskDeleteModal({ error, isSaving, task, t, onClose, onSubmit }: TaskDeleteModalProps) {
  return (
    <Modal
    ...
    >
      ...
      <p className="project-delete-warning">{t.deleteTaskWarning.replace("{name}", task.name)}</p>
    </Modal>
  );
}
